...
public class Course implements Serializable {
    ...
    private long id;
    @NotBlank(message = "Il corso deve avere un titolo.")
    ...
    public Course(String title, String description, String program, double duration,boolean isActive,
                  LocalDate createdAt){
        this(0, title, description, program, duration, isActive, createdAt);
    }
